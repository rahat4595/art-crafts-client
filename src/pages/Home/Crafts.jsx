        ...
        <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-start">
                    <Link to={{ pathname: "/craft-details", state: { craft } }} className="text-xl font-semibold px-5 py-2 bg-black text-white rounded-md mt-10 relative overflow-hidden group">
